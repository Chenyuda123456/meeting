...
<script lang="ts" setup>
  ...
  import { addObj, editObj, viewObj } from '/@/api/modules/system/sysDictItemApi';
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ? await addObj({ ...values, dictId: dictId.value })
        : await editObj({ ...values, id: rowId.value, dictId: dictId.value });
